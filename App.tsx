...
const AppContent: React.FC = () => {
  ...
  if (error) {
    return (
      <div className="h-screen-safe w-screen flex flex-col items-center justify-center bg-black text-white p-4">
  ...
  return (
    <div className={`h-screen-safe w-screen overflow-hidden bg-black text-white grid grid-cols-1 transition-[grid-template-columns] duration-300 ease-in-out relative
    ...
    `}>
      ...
      <main className="h-full relative min-w-0 z-0 bg-black">
        <MapContainer
